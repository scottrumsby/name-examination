      ...
      <v-flex style="min-height: 400px;">
        <v-data-table :headers="headers"
          ...
          <template v-slot:headers="{item, index}">
            <tr>
              <th v-for="heading in headers"
                  class="text-left header-row-1 pa-0 pl-2">
                {{ heading.text }}
              </th>
            </tr>
            <tr class="header-row-2">
              <th style="width: 125px" class="pa-0 px-1">
              ...
              <th style="width: 150px" class="pa-0 px-1">
              ...
              <th style="width: 100px" class="pa-0 px-1">
              ...
              <th style="width: 425px" class="pa-0 px-1">
              ...
              <th style="width: 225px" class="pa-0 px-1"/>
              <th style="width: 100px" class="pa-0 px-1">
              ...
              <th style="width: 175px" class="pa-0 px-1">
  ...
  data: function () {
    return {
      headers:[
        ...
        {value:'LastModifiedBy', text: 'Last Modified By',},
        {value:'NameRequestNumber', text: 'NR Number',},
        {value:'Names', text: 'Names',},
        {value:'NatureOfBusiness', text: 'Nature Of Business',},
        {value:'Priority', text: 'Priority',},
        {value:'ClientNotification', text: 'Client Notification', },
        {value:'Submitted', text: 'Submitted',},
        {value:'LastUpdate', text: 'Last Update',},
        {value:'LastComment', text: 'Last Comment',},
      ],
      data: [],
