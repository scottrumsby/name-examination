      ...
      <v-layout align-start
        ...
        <v-flex fs-15 shrink ml-2>
          <v-layout column>
            ...
            <v-flex><b>Status:</b><span id="nrStatusText">
        ...
        <v-flex shrink fs-15 :ml-2="is_expanded">
          <v-layout column>
            <v-flex><b>Submission:</b> {{ formatDate(submittedDate) }}</v-flex>
            ...
            <v-flex v-if="expiryDate !== null">
              <v-layout column>
                <v-flex v-if="!is_editing && expiryDateForEdit != null">
                  <b>Expiry: </b>{{ formatDate(expiryDateForEdit) }}
                </v-flex>
            ...
            <v-flex :class="!consumptionDate ? 'grey--text' : ''">
              <b>Consumed:</b> {{ consumptionDate ? formatDate(consumptionDate) : 'n/a' }}
            </v-flex>
            <template v-if="1===2">
