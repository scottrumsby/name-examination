 ...
 <v-flex shrink pr-4 v-show="!is_editing" align-self-center>
   ...
   <v-btn flat
     ...
     <img v-if="is_viewing"
          ...
          src="/static/images/buttons/hide-details.svg"/>
     <img v-else
          id="show-details-graphic"
          src="/static/images/buttons/show-details.svg"/>
   </v-btn>
   ...
   <v-btn flat
          ...
          @click="nameAccept()">
     <img v-if="acceptance_will_be_conditional" src="/static/images/buttons/dec-cond-approve.svg"/>
     <img v-else src="/static/images/buttons/dec-approve.svg"/>
   </v-btn>
   <v-btn flat
          v-shortkey="['alt', 'r']"
          @shortkey="nameReject()"
          ...
          @click="nameReject()"><img src="/static/images/buttons/dec-reject.svg"/></v-btn>
   <v-btn flat
          v-shortkey="['alt', 'c']"
          ...
          v-if="is_making_decision"
          @click="is_making_decision=false"><img src="/static/images/buttons/dec-back.svg"/></v-btn>
